    ...
    $scope.updateFtpOsm = function () {
        ...
        myfactory.get_data("/thematique/genrateAutomaticJsonFileByCat/").then(function (resp) {
            ...
            if (requete_reussi(resp)) {
                ...
                $('#spinner').hide()
                toogle_information('une erreur : Verifier toutes les requetes osm pour chercher l erreur  ')
            }

        }, function (msg) {
            alert('une erreur : Verifier toutes les requetes osm pour chercher l erreur ')
            $('#spinner').hide()
        })
    }
