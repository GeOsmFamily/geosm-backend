    ...
    public function add(Request $Requests)
    {
        ...
        try {
            ...
            $querry = DB::table('utilisateur')->insertGetId(
                ['nom' => $nom, 'src_photo' => $nom_img, 'email' => $email, 'droit' => $statut,  'telephone' => $numero, 'mot_de_passe' => $mot_passe, 'id_instances_gc' => $this->id_instance_gc],
                'id_utilisateur'
            );
